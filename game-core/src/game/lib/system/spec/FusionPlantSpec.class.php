 ...
 */
class FusionPlantSpec extends Spec implements ProductionSpec {
	/**
	...
	public function getProduction(ResourceProduction $prodObj) {
		...
		return array(
			'deuterium' => -10 * $planet->fusion_plant * pow(1.1, $planet->fusion_plant),
			'energy' => 50 * $planet->fusion_plant * pow(1.1, $planet->fusion_plant)
		);
	}
}
?>